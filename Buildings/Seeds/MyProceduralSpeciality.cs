...
namespace Equinox.ProceduralWorld.Buildings.Seeds
{
    public class MyProceduralStationSpeciality
    {
        ...
        {
            return m_imports?.Invoke(b) ?? true;
        }

        private MyProceduralStationSpeciality(MyDefinitionTester exports, double prependSingleItem, string[] generalizedPrefixes, string[] suffixes, MyDefinitionTester imports = null)
        {
            m_exports = exports;
            m_imports = imports;
        ...
        private MyProceduralStationSpeciality(MyDefinitionTester exports, string[] names, MyDefinitionTester imports = null)
        {
            m_exports = exports;
            m_imports = imports;
        ...
        // Mining asteroids
        public static readonly MyProceduralStationSpeciality MiningAbundant = new MyProceduralStationSpeciality(new MyDefinitionFilter().OrTypeTester(typeof(MyObjectBuilder_Ore), x => MyOreUtilities.GetRarity(x.Id) <= 0.75), new[] { "Ores", "Minerals", "Resources", "Materials" });
        public static readonly MyProceduralStationSpeciality MiningRares = new MyProceduralStationSpeciality(new MyDefinitionFilter().OrTypeTester(typeof(MyObjectBuilder_Ore), x => MyOreUtilities.GetRarity(x.Id) >= 0.65), new[] { "Rare Ores", "Rare Minerals" });
        // Gas production
        public static readonly MyProceduralStationSpeciality HydrogenFuelStation = new MyProceduralStationSpeciality(new MyDefinitionFilter().OrTypeSubtype(typeof(MyObjectBuilder_GasProperties), "Hydrogen"), new[] { "Hydrogen Station", "Fuel Depot", "Fuel Station" });
        public static readonly MyProceduralStationSpeciality UraniumFuelStation = new MyProceduralStationSpeciality(new MyDefinitionFilter().OrTypeSubtype(typeof(MyObjectBuilder_Ingot), "Uranium"), new[] { "Uranium Depot", "Fuel Depot", "Fuel Station" });
        public static readonly MyProceduralStationSpeciality OxygenStation = new MyProceduralStationSpeciality(new MyDefinitionFilter().OrTypeSubtype(typeof(MyObjectBuilder_GasProperties), "Oxygen"), new[] { "Oxygen Station", "Life Support" });
        // Ore refinery
        public static readonly MyProceduralStationSpeciality Refinery = new MyProceduralStationSpeciality(new MyDefinitionFilter().OrType(typeof(MyObjectBuilder_Ingot)), 0.5, new[] { "" }, new[] { "Refinery", "Smeltery", "Forge" });
        // Assembly
        public static readonly MyProceduralStationSpeciality AssemblyWeaponsAmmo = new MyProceduralStationSpeciality(WeaponryFilter, 0.1, new[] { "Weapon", "Ammo", "Military", "Munitions" }, ShopSuffixes);
        public static readonly MyProceduralStationSpeciality AssemblyTools = new MyProceduralStationSpeciality(new MyDefinitionFilter().OrType(typeof(MyObjectBuilder_Welder), typeof(MyObjectBuilder_AngleGrinder), typeof(MyObjectBuilder_HandDrill), typeof(MyObjectBuilder_GasContainerObject), typeof(MyObjectBuilder_OxygenContainerObject)), 0.1, new[] { "Tool" }, ShopSuffixes);
        public static readonly MyProceduralStationSpeciality AssemblyComponents = new MyProceduralStationSpeciality(new MyDefinitionFilter().OrType(typeof(MyObjectBuilder_Component)), 0.2, new[] { "Component", "Part" }, ShopSuffixes);
        // Repair
        public static readonly MyProceduralStationSpeciality ShipRepair = new MyProceduralStationSpeciality(BuildingEquipment, new[] { "Repair Yard", "Repair Shop", "Junk Yard" });
        public static readonly MyProceduralStationSpeciality ShipConstruction = new MyProceduralStationSpeciality(BuildingEquipment, new[] { "Shipyard", "Construction Outpost", "Builder Shop" });
        // Military
        public static readonly MyProceduralStationSpeciality DefenseStation = new MyProceduralStationSpeciality(NothingFilter, new[] { "Military Outpost", "Defense Outpost" }, imports: new MyDefinitionFilter().Append(OxygenAndFuelFilter).Append(WeaponryFilter));
        // Housing
        public static readonly MyProceduralStationSpeciality Housing = new MyProceduralStationSpeciality(new MyDefinitionFilter().OrType(typeof(MyObjectBuilder_OxygenContainerObject)), new[] { "Hovels", "Shacks", "Apartments" }, imports: OxygenAndFuelFilter);
        public static readonly MyProceduralStationSpeciality LuxuryHousing = new MyProceduralStationSpeciality(new MyDefinitionFilter().OrType(typeof(MyObjectBuilder_OxygenContainerObject)), new[] { "Condo", "Villa", "Luxury Hotel" }, imports: OxygenAndFuelFilter);
        public static readonly MyProceduralStationSpeciality Trading = new MyProceduralStationSpeciality(AcceptFilter, new[] { "Trading Outpost", "Exchange", "Junk Emporium" }, imports: AcceptFilter);
    }
