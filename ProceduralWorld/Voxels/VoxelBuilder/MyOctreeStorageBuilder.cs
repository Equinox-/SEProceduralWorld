...
namespace Equinox.ProceduralWorld.Voxels.VoxelBuilder
{
    ...
    public partial class MyOctreeStorageBuilder
    {
        ...
        public IMyStorageDataProviderBuilder DataProvider;
        ...
        public MyOctreeStorageBuilder(IMyStorageDataProviderBuilder dataProvider, Vector3I size)
        {
            {
        ...
        protected void SaveInternal(MyMemoryStream stream)
        {
        ...
        public byte[] GetCompressedData()
        {
            MyMemoryStream ms;
            byte[] copy;
            using (ms = MyMemoryStream.CreateEmptyStream(0x4000))
            {
