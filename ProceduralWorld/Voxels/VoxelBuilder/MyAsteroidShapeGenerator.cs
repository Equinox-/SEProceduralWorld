...
{
    public class MyAsteroidShapeGenerator
    {
        #region Utils
        public struct MyCompositeShapeGeneratedDataBuilder
        {
            public IMyModule MacroModule;
            public IMyModule DetailModule;
            public MyCsgShapeBaseBuilder[] FilledShapes;
            public MyCsgShapeBaseBuilder[] RemovedShapes;
            public MyVoxelMaterialDefinition DefaultMaterial;
            public MyCompositeShapeOreDepositBuilder[] Deposits;
        }

        public class MyCsgShapeBaseBuilder
        {
        }

        public class MyCsgTorusBuilder : MyCsgShapeBaseBuilder
        {
            public MyCsgTorusBuilder(Vector3 translation, Quaternion invRotation, float primaryRadius, float secondaryRadius, float secondaryHalfDeviation, float deviationFrequency, float detailFrequency)
            {
            }
        }

        public class MyCsgSphereBuilder : MyCsgShapeBaseBuilder
        {
            public MyCsgSphereBuilder(Vector3 translation, float radius, float halfDeviation = 0, float deviationFrequency = 0, float detailFrequency = 0)
            {
            }
        }

        public class MyCsgCapsuleBuilder : MyCsgShapeBaseBuilder
        {
            public MyCsgCapsuleBuilder(Vector3 pointA, Vector3 pointB, float radius, float halfDeviation, float deviationFrequency, float detailFrequency)
            {
            }
        }

        public struct MyCompositeShapeOreDepositBuilder
        {
            public MyVoxelMaterialDefinition Material;
            public MyCsgShapeBaseBuilder Shape;
        }
        ...
        public delegate void MyCompositeShapeGeneratorDelegate(int seed, float size, out MyCompositeShapeGeneratedDataBuilder data);
        ...
        private static void Generator0(int seed, float size, out MyCompositeShapeGeneratedDataBuilder data)
        {
            Generator(0, seed, size, out data);
        }

        //Added ice material
        private static void Generator1(int seed, float size, out MyCompositeShapeGeneratedDataBuilder data)
        {
            Generator(1, seed, size, out data);
        }

        private static void Generator2(int seed, float size, out MyCompositeShapeGeneratedDataBuilder data)
        {
            Generator(2, seed, size, out data);
        }

        private static void Generator(int version, int seed, float size, out MyCompositeShapeGeneratedDataBuilder data)
        {
            var random = MyRandom.Instance;
            using (var stateToken = random.PushSeed(seed))
            {
                data = new MyCompositeShapeGeneratedDataBuilder();
                data.FilledShapes = new MyCsgShapeBaseBuilder[2];
                data.RemovedShapes = new MyCsgShapeBaseBuilder[2];
                ...
                MyCsgShapeBaseBuilder primaryShape;
                { // determine primary shape
                    ...
                    switch (primaryType)
                    {
                        case 0: //ShapeType.Torus
                            {
                                ...
                                var torus = new MyCsgTorusBuilder(
                        ...
                        default:
                            {
                                var sphere = new MyCsgSphereBuilder(
                                    translation: new Vector3(halfStorageSize),
                            ...
                            case 1: //ShapeType.Capsule
                                {
                                    ...
                                    var capsule = new MyCsgCapsuleBuilder(
                ...
                { // generating materials
                    ...
                    data.Deposits = new MyCompositeShapeOreDepositBuilder[depositCount];
                    ...
                    for (var i = 0; i < data.FilledShapes.Length; ++i)
                    {
                        ...
                        data.Deposits[i] = new MyCompositeShapeOreDepositBuilder() { Shape = data.FilledShapes[i], Material = material };
                        random.NextFloat();
                    ...
                    for (var i = data.FilledShapes.Length; i < depositCount; ++i)
                    {
                        ...
                        MyCsgShapeBaseBuilder shape = new MyCsgSphereBuilder(center, radius);
                        ...
                        data.Deposits[i] = new MyCompositeShapeOreDepositBuilder() { Shape = shape, Material = material };
