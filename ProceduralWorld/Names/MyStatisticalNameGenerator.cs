...
{
    public class MyStatisticalNameGenerator : MyNameGeneratorBase
    {
        ...
        {
            using (var stream = MyMemoryStream.CreateEmptyStream(database.Count * 10))
            {
        ...
        {
            var config = configOriginal as MyObjectBuilder_StatisticalNameGenerator;
            if (config == null)
            {
        ...
        public override MyObjectBuilder_ModSessionComponent SaveConfiguration()
        {
            ...
            return new MyObjectBuilder_StatisticalNameGenerator() { StatisticsDatabase = database };
        }
    }

    public class MyObjectBuilder_StatisticalNameGenerator : MyObjectBuilder_NameGeneratorBase
    {
