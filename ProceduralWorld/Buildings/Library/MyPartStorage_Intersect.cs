...
namespace Equinox.ProceduralWorld.Buildings.Library
{
    public partial class MyPartStorage
    {
        ...
        // Target a 16MB cache.
        private static readonly MyLRUCache<IntersectKey, bool> IntersectionCache = new MyLRUCache<IntersectKey, bool>(16 * 1024 * 1024 / (2 * 8 + 2 * 16 * 4), new IntersectKeyEquality());
