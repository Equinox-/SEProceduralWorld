    ...
    public class MyPartMountPointBlock
    {
        ...
        public void Init(MyObjectBuilder_CubeBlock block, string piece, IEnumerable<string> args)
        {
            ...
            foreach (var arg in args)
            {
                ...
                {
                    Vector3I anchor;
                    if (MyPartDummyUtils.TryParseVector(arg.Substring(MyPartDummyUtils.ArgumentAnchorPoint.Length), out anchor))
                    {
        ...
        public bool TypeEquals(MyPartMountPointBlock other)
        {
