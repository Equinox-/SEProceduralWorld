...
namespace ProcBuild.Seeds
{
    public class MyProceduralWorld
    {
        ...
        private MyProceduralWorld()
        {
            ...
            m_oreNoise = new MyCompositeNoise(8, 1 / Settings.Instance.OreMapDensity, rand.Next());
            StationNoise = new MyOctreeNoise(rand.NextLong(), Settings.Instance.StationMaxSpacing, Settings.Instance.StationMinSpacing);
        }

        // Voronoi Noise with variable density
